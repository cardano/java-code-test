...
public class CodeTest {
    ...
    public static long findWordCount(String text, String wordToFind) {
        // add code here
    ...
    public static void writeContentsToConsole() {
        // add code here
        try {
            FileInputStream fileReader = new FileInputStream("src\\main\\resources\\sample_test_file.txt");
            System.out.println(" Writing file content to console : ");
            int i=0;
            ...
            System.out.println("Failed to read from the file " + iexp.getMessage());
        }
    }
